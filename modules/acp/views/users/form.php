...
<div class="mw-500px">
    ...
    <? if(Yii::$app->user->identity->isSuperAdmin == 'Y'){?>
        <div class="row">
            <div class="col-12 col-md-6">
                <select class="form-select  mb-5 tt-shadow-sm" name="active" data-control="select2" data-placeholder="Status">
                    <option></option>
            ...
            <?if($lang['code'] == 'en'){?>
                ...
                <div class="tab-pane fade show active" id="user_general_lang_en" role="tabpanel">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-floating  tt-form-floating-icon mb-5">
                                <input type="text" name="prefixName" class="form-control tt-shadow-sm" value="<?=$user->prefixName?>" id="prefixName" placeholder="Name prefix"/>
                                <label for="prefixName">Name prefix</label>
                                <span class="svg-icon">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-floating  tt-form-floating-icon mb-5">
                                <input type="text" name="middleName" class="form-control tt-shadow-sm" value="<?=$user->middleName?>" id="middleName" placeholder="Middle Name"/>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-floating  tt-form-floating-icon mb-5">
                                <input type="text" name="suffixName" class="form-control tt-shadow-sm" value="<?=$user->suffixName?>" id="suffixName" placeholder="Name suffix"/>
                                <label for="suffixName">Name suffix</label>
                                <span class="svg-icon">
                                    <i class="bi bi-person-badge"></i>
                                </span>
                            </div>
                    ...
                    <? if(Yii::$app->user->identity->isSuperAdmin == 'Y'){?>
                        ...
                        <select class="form-select  mb-5 tt-shadow-sm" name="dep_id" data-control="select2" data-placeholder="Select department">
                            <option></option>
                            <?php
                    ...
                    <div class="form-floating mb-5">
                        <textarea class="form-control" name="note" placeholder="Note" id="userNote" style="height: 150px"><?=$user['note']?></textarea>
                    ...
                    <div class="menu menu-column my-10">
                        ...
                        <div class="menu-item">
                            <a  href="#" class="menu-link" role="button" data-bs-toggle="modal" data-bs-target="#tt_phone_modal">
                                ...
                                <span class="menu-badge">
                                    <span class="badge badge-sm badge-circle badge-danger" data-bages-count-phones><?=count($user->getProps('phone'))?></span>
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a href="#" class="menu-link"  role="button" data-bs-toggle="modal" data-bs-target="#tt_websites_modal">
                                ...
                                <span class="menu-badge">
                                        <span class="badge badge-sm badge-circle badge-danger"  data-bages-count-website><?=count($user->getProps('website'))?></span>
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a href="#" class="menu-link"  role="button" data-bs-toggle="modal" data-bs-target="#tt_emails_modal">
                                ...
                                <span class="menu-badge">
                                      <span class="badge badge-sm badge-circle badge-danger"  data-bages-count-emails><?=count($user->getProps('email'))?></span>
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a href="#" class="menu-link"  role="button" data-bs-toggle="modal" data-bs-target="#tt_addresses_modal">
                                ...
                                <span class="menu-badge">
                                        <span class="badge badge-sm badge-circle badge-danger" data-bages-count-addresses><?=count($user->getProps('address'))?></span>
                                    </span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a href="#" class="menu-link"  role="button" data-bs-toggle="modal" data-bs-target="#tt_smm_modal">
                                ...
                                <span class="menu-badge">
                                        <span class="badge badge-sm badge-circle badge-danger"  data-bages-count-smm><?=count($user->getProps('socialmedia'))?></span>
                                    </span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a href="#" class="menu-link"  role="button" data-bs-toggle="modal" data-bs-target="#tt_youtube_link_modal">
                                    <span class="menu-icon">
                                        <i class="bi bi-camera-reels fs-2"></i>
                                    </span>
                                <span class="menu-title fs-2 text-dark fw-bold">Video</span>
                                <span class="menu-badge">
                                        <span class="badge badge-sm badge-circle badge-danger"  data-bages-count-video><?=count($user->getProps('youtube_link'))?></span>
                                    </span>
                            </a>
                        </div>
            ...
            <?}else{?>
                <div class="tab-pane fade" id="user_general_lang_<?=$lang['code']?>" role="tabpanel" <?=($lang['dir'] == 'RTL') ? ' dir="rtl"' : ''?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-floating  tt-form-floating-icon mb-5">
                                <input type="text" name="langUser[<?=$lang['id']?>][prefixName]" class="form-control tt-shadow-sm" value="<?=$user->getTranslate($lang['id'],'prefixName')?>" id="prefixName" placeholder="Name prefix"/>
                                <label for="firstName">Name prefix</label>
                                <span class="svg-icon">
                                    <i class="bi bi-person-badge"></i>
                                </span>
                            </div>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-floating  tt-form-floating-icon mb-5">
                                <input type="text" name="langUser[<?=$lang['id']?>][firstName]" class="form-control tt-shadow-sm" value="<?=$user->getTranslate($lang['id'],'firstName')?>" id="firstName" placeholder="First Name"/>
                                <label for="firstName">First Name</label>
                                <span class="svg-icon">
                                    <i class="bi bi-person-badge"></i>
                                </span>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-floating  tt-form-floating-icon mb-5">
                                <input type="text" name="langUser[<?=$lang['id']?>][middleName]" class="form-control tt-shadow-sm" value="<?=$user->getTranslate($lang['id'],'middleName')?>" id="middleName" placeholder="Middle Name"/>
                                <label for="middleName">Middle name</label>
                                <span class="svg-icon">
                                    <i class="bi bi-person-badge"></i>
                                </span>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-floating  tt-form-floating-icon mb-5">
                                <input type="text" name="langUser[<?=$lang['id']?>][lastName]" class="form-control tt-shadow-sm" value="<?=$user->getTranslate($lang['id'],'lastName')?>" id="lastName" placeholder="Last Name"/>
                                <label for="lastName">Last Name</label>
                                <span class="svg-icon">
                                     <i class="bi bi-person-badge"></i>
                                </span>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-floating  tt-form-floating-icon mb-5">
                                <input type="text" name="langUser[<?=$lang['id']?>][suffixName]" class="form-control tt-shadow-sm" value="<?=$user->getTranslate($lang['id'],'suffixName')?>" id="suffixName" placeholder="Name suffix"/>
                                <label for="firstName">Name suffix</label>
                                <span class="svg-icon">
                                    <i class="bi bi-person-badge"></i>
                                </span>
                            </div>
                    ...
                    <div class="form-floating  tt-form-floating-icon mb-5">
                        <input type="text" name="langUser[<?=$lang['id']?>][role]" class="form-control tt-shadow-sm" value="<?=$user->getTranslate($lang['id'],'role')?>" id="userRole" placeholder="User role"/>
                        <label for="userRole">Role</label>
                        <span class="svg-icon">
                             <i class="bi bi-dpad"></i>
                        </span>
                    ...
                    <div class="form-floating mb-5">
                        <textarea class="form-control" name="langUser[<?=$lang['id']?>][note]" placeholder="Note" id="userNote" style="height: 150px"><?=$user->getTranslate($lang['id'],'note')?></textarea>
                        <label for="userNote">Note</label>
                    </div>
                    ...
                    <h2 class="mb-5 mt-10" dir="ltr">Addresses</h2>
                        <?
                        $i = 0;
                        foreach ($userAddress as $address){
                            $imAddres = [];
                            $curentAddress = unserialize($address['value']);
                            foreach ($curentAddress as $in=>$vAdres){
                                if(!empty($vAdres) and $in != 'type'){
                                    $imAddres[] = $vAdres;
                                }
                            }
                            $translateAddress = unserialize($address['translate'][$lang['id']]['value']);

                            ?>
                            <div class="mb-3" dir="ltr">
                                <small><?=\app\models\user\Props::$fields['address']['type'][$address['type']]?></small>
                                <div><?=implode(', ',$imAddres)?></div>
                            </div>


                            <div class="row pb-5 mb-5">
                                <div class="col-md-12">
                                    <input type="text" name="langAddress[<?=$i?>][<?=$lang['id']?>][street]" value="<?=$translateAddress['street']?>" class="form-control tt-shadow-sm mb-2" placeholder="House and street" />
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="langAddress[<?=$i?>][<?=$lang['id']?>][address]" value="<?=$translateAddress['address']?>" class="form-control tt-shadow-sm mb-2" placeholder="Locality" />
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="langAddress[<?=$i?>][<?=$lang['id']?>][index]" value="<?=$translateAddress['index']?>" class="form-control tt-shadow-sm mb-2" placeholder="Zip code" />
                                </div>
                                <div class="col-md-4">
                                    <input type="text" name="langAddress[<?=$i?>][<?=$lang['id']?>][country]" value="<?=$translateAddress['country']?>" class="form-control tt-shadow-sm mb-2" placeholder="Country" />
                                </div>
                            </div>
                        <?
                            $i++;
    ...
    <div class="modal fade" tabindex="-1" id="tt_youtube_link_modal">
        <div class="modal-dialog  modal-lg modal-dialog-scrollable  modal-fullscreen-md-down">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">Link to video</h2>
                    <!--begin::Close-->
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                        <span class="svg-icon svg-icon-2x">
                            <i class="bi bi-x-circle"></i>
                ...
                <?php
                $userFiels = $user->getProps('youtube_link');
                $userFielsCount =  count($userFiels);
                $userFielsCountFor = ($userFielsCount == 0) ? 1 : $userFielsCount;
                ?>

                <div class="modal-body" id="profile_repeater_youtube_link" data-count="<?=($userFielsCount)?>">
                    <div data-repeater-list="user_youtube_link">
                        <? for ($i = 0; $i < $userFielsCountFor; $i++){?>
                            <div data-repeater-item class="form-group row mb-4">
                                <div class="col-7 col-md-10">
                                    <input type="text" name="youtube_link" value="<?=$userFiels[$i]['value']?>" class="form-control mb-2 mb-md-0" placeholder="Enter link" />
                                </div>
                                <div class="col-5 col-md-2">
                                    <a href="javascript:;" data-repeater-delete class="btn btn-icon btn-circle btn-light-danger">
                                        <i class="la la-trash-o"></i>
